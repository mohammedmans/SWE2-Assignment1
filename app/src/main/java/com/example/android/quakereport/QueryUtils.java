...
/**
 * Created by Mohammed on 1/31/2018.
 */
...
public final class QueryUtils {
    ...
    * make all other helper methods in QueryUtils “private”.*/
    public static List<Quake> fetchEarthquakeData(String requestUrl) {
        ...
        // Extract relevant fields from the JSON response and create a list of {@link Quake}s
    ...
    public static List<Quake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i < features.length(); ++i) {
                ...
                JSONObject featuresI = features.getJSONObject(i);

                // For a given earthquake, extract the JSONObject associated with the
                // key called "properties", which represents a list of all properties
                // for that earthquake.
                // Get “properties” JSONObject
                JSONObject properties = featuresI.getJSONObject("properties");
                ...
                // convert time in millisecond to simple time
                ...
                /* we can convert millisecondtime here but should do converting in QuakeAdapter class
                ...
                */
                ...
                Quake quake = new Quake(mag, place, time, url);
